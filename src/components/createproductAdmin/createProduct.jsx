      ...
      <div className={styles.containerForm}>
        <div className={styles.productContainer}>
          <form className={styles.form} onSubmit={(e) => handleSubmit(e)}>
            ...
            />
            <br />
            {errors.cost && <p className={styles.textError}>{errors.cost}</p>}
            ...
            />
            <br />
            {errors.brand && <p className={styles.textError}>{errors.brand}</p>}
          ...
          onChange={(e)=> handleInput(e)} /><br/>
            ...
            <br />
            {/* </FormGroup> */}
            {errors.img && <p className={styles.textError}>{errors.img}</p>}
            ...
            />
            <br />
            {errors.type && <p className={styles.textError}>{errors.type}</p>}
