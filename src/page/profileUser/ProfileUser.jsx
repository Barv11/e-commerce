      ...
      <div className={style.cardUser}>
        <div>
          <div className={style.headProfile}>
            <img src={fakePeople1} alt="fakePeople1" className={style.imgProfile}/>
            <div>
              <h3>Hola! <strong>Laura Torres</strong></h3>
              <p>Premium</p>
            </div>
          </div>
        ...
        <Accordion.Item eventKey="0" className={style.eachItem}>
          ...
          <Accordion.Body className={style.insideItem}>
            ...
            <h3 className={style.subtitle}>Account data</h3>
              <div>
                <span>UserName:</span><CardProfle name={"Lau34"}/>
              </div>
              <div>
                <span>Email:</span><CardProfle name={"lau@gmail.com"}/>
              </div>
                <h3 className={style.subtitle}>Personal Data</h3>
              <div>
                <span>Name:</span><CardProfle name={"Laura Torres"}/>
              </div>
              <div>
                <span>Phone Number:</span><CardProfle name={'559291023'}/>
              </div>
            </div>
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="1">
          ...
          <CreditCardIcon/><CardProfle name={"************** 3479"}/>
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            ...
            <HomeIcon/><CardProfle name={"Calle Alcala 34 Buenos aires, Arg"}/>
        ...
        <Accordion.Item eventKey="3">
          ...
          <ReviewsIcon/><CardProfle name={"Rating 1"}/>
