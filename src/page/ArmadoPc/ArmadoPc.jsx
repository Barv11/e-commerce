    ...
    if(choice.procesador !== ''){
            ...
            <div>
                ...
                <div className={style.cardContainer}>
                    ...
                    <div className={style.cardChoice}>
                        ...
                        <div>
                            <button onClick={handleChoice} value='baja'>Comenzar</button>
                        </div>
                    </div>
                    ...
                    <div className={style.cardChoice}>
                        ...
                        <div>
                            <button onClick={handleChoice} value='media'>Comenzar</button>
                        </div>
                    </div>
                    ...
                    <div>
                        <button onClick={handleChoice} value='alta'>Comenzar</button>
                    </div>
                    </div>
                    ...
                    <div className={style.cardChoice}>
                        ...
                        <div>
                            <button onClick={handleChoice} value='superAlta'>Comenzar</button>
                        </div>
                    </div>
                </div>
            <Footer/>
        ...
        return (
            ...
            <div className={style.choice}>
                <button className={style.intel} onClick={() => setChoice({...choice, procesador: 'Intel'})}></button>
                <button className={style.amd} onClick={() => setChoice({...choice, procesador: 'AMD'})}></button>
            </div>
          <Footer/>
        </div>
